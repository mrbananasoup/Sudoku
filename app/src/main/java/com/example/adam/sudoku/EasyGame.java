...
public class EasyGame extends SudokuBoard
{
    @Override
    protected void makeHoles()
    {
        double remainingSquares = 81;
        double remainingHoles = 20;
    ...
    public boolean manualCheckCell(int x, int y)
    {
        if(solutionBoard[x][y].getNumber() == gameBoard[x][y].getNumber()) return true;
        return false;
    }
}
